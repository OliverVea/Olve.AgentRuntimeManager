...
- The contract is `src/spec/main.tsp`; OpenAPI and clients are build artifacts. The backend surface will be generated by our own TypeSpec emitter (M3, `docs/SPEC-FIRST.md`)
