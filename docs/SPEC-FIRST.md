...
`test/` holds the snapshot fixture. The hand-written runtime it targets (`ArmOperation`,
...
- [x] Snapshot tests of the emitter output; contract tests stay the conformance gate
