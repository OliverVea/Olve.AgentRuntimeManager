...
- **C1. Registration (2026-09-26):** routes in Olve.Homelab (`olve-arm-beta.ovea.pro`,
  `olve-arm-private.ovea.pro`, both Tailscale-private, so `/health` isn't public) and Authentik
